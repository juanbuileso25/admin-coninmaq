...
import {
  ...
  Pencil, Trash2, AlertTriangle, Filter, ImageOff, Loader2, Clock, Calendar, Copy, Images,
} from "lucide-react";
...
/* ── Main page ── */
export default function MaquinariaRentaPage() {
  const { machines, loading, error, addMachine, updateMachine, removeMachine, toggleField, refresh } = useMachines("rental");
    ...
    <div className="space-y-5 max-w-[1200px]">
      ...
      <div className="flex items-start justify-between gap-4 animate-fade-up">
        <div>
          ...
          <h1 className="text-fg text-xl font-semibold">Maquinaria en Renta</h1>
        </div>
        <button
          onClick={openCreate}
